    ...
    <div className="space-y-6 pb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        ...
        <div className="bg-blue-50 border border-blue-200 p-5 rounded-2xl flex flex-col justify-between">
          ...
          <p className="text-xs text-slate-500 mt-4">Barcha mijozlar avtomatik ravishda toifalarga ajratiladi.</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
        <div className="p-5 border-b border-slate-200 bg-slate-50/50 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="max-w-md relative flex-1">
            ...
            <Input className="pl-10 rounded-xl bg-white h-10 border-slate-200" placeholder="Kategoriya nomi yoki tavsifini yozing..."
          ...
          renderRow={(category) => {
            ...
            return (
              <>
                ...
                <td className="px-3 py-4 text-[13px] text-slate-500 max-w-[250px] truncate">{category.description}</td>
                <td className="whitespace-nowrap px-3 py-4 text-[14px] font-extrabold text-slate-900">
