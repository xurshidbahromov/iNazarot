        ...
        <div className="w-full md:w-72 flex-shrink-0 space-y-1.5">
          {categories.map(category => {
            ...
            return (
              ...
              >
                <div className={cn('w-10 h-10 rounded-xl flex items-center justify-center transition-colors shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)]',
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-1.5">
                  ...
                  <input type="text" defaultValue="iNazorat LLC" className="w-full h-11 px-4 bg-white/80 backdrop-blur-md border border-slate-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary-500/30 focus:border-primary-500 transition-all shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)]" />
                </div>
                <div className="space-y-1.5">
                  <label className="text-[13px] font-medium text-slate-700 flex items-center gap-2 mb-1.5">
                  ...
                  <select className="w-full h-11 px-4 bg-white/80 backdrop-blur-md border border-slate-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary-500/30 focus:border-primary-500 transition-all shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)]">
                ...
                <div className="space-y-1.5">
                  ...
                  <input type="text" defaultValue="+998 90 123 45 67" className="w-full h-11 px-4 bg-white/80 backdrop-blur-md border border-slate-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary-500/30 focus:border-primary-500 transition-all shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)]" />
                </div>
                <div className="space-y-1.5">
                  <label className="text-[13px] font-medium text-slate-700 flex items-center gap-2 mb-1.5">
                  ...
                  <input type="email" defaultValue="info@inazorat.uz" className="w-full h-11 px-4 bg-white/80 backdrop-blur-md border border-slate-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary-500/30 focus:border-primary-500 transition-all shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)]" />
                </div>
                <div className="space-y-1.5 md:col-span-2">
                  ...
                  <input type="text" defaultValue="Toshkent sh., Chilonzor tumani, 1-mavze" className="w-full h-11 px-4 bg-white/80 backdrop-blur-md border border-slate-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary-500/30 focus:border-primary-500 transition-all shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)]" />
                </div>
              </div>

              <div className="pt-4 flex justify-end">
                <button className="flex items-center gap-2 h-11 px-6 bg-primary-600 text-white rounded-xl text-sm font-semibold hover:bg-primary-700 transition-colors shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)]">
