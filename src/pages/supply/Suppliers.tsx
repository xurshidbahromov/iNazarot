    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap gap-2.5">
          <button className="flex items-center gap-2 h-10 px-4 bg-primary-600 text-white rounded-xl text-[14px] font-semibold hover:bg-primary-700 transition-colors shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)]">
      ...
      <div className="relative max-w-md">
        ...
        <input
          ...
          className="w-full h-11 pl-11 pr-4 bg-white/80 backdrop-blur-md border-2 border-[#f1f2f4] rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary-500/30 focus:border-primary-500 transition-all shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)]"
        />
      </div>
            ...
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <span className="text-[12px] font-medium text-slate-500 bg-slate-100 px-2 py-0.5 rounded-md border-2 border-[#f1f2f4] mt-1 inline-block">
                    {supplier.category}
                  </span>
                </div>
              </div>
              <div className="flex items-center">
                <div className="relative group">
                  ...
                  <div className="absolute right-0 top-full mt-1 w-36 bg-white/80 backdrop-blur-md border-2 border-[#f1f2f4] rounded-xl shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-10 overflow-hidden">
                    <button className="w-full flex items-center gap-2 px-4 py-2.5 text-[13px] font-medium text-slate-600 hover:bg-slate-50  :bg-slate-800/50 text-left">
