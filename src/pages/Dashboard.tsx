          ...
          {isAIOpen ? (
            ...
            <div className="flex items-center gap-3 pr-2">
              <Link
                ...
                className="hidden sm:inline-flex items-center gap-1.5 text-xs font-bold text-emerald-700 dark:text-emerald-300 bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-200 dark:border-emerald-500/20 px-3 py-1.5 rounded-xl hover:bg-emerald-100 dark:hover:bg-emerald-500/20 transition-all"
              >
              ...
              <span className="flex items-center gap-1.5 text-[13px] font-bold text-slate-700 dark:text-slate-200 bg-white dark:bg-white/5 shadow-sm px-4 py-2 rounded-xl border border-slate-200 dark:border-transparent transition-all group-hover:bg-slate-900 dark:group-hover:bg-white/10 group-hover:text-white group-hover:border-slate-800">
                Tavsiyalar <ChevronRight className="w-3.5 h-3.5" />
              </span>
            </div>
          )}
        </div>
        ...
        <div className={`relative z-10 grid transition-all duration-[600ms] ease-[cubic-bezier(0.16,1,0.3,1)] ${isAIOpen ? 'grid-rows-[1fr] opacity-100' : 'grid-rows-[0fr] opacity-0'}`}>
          <div className="overflow-hidden">
            ...
            {isAnalyzing ? (
              ...
              <div className="mt-5 pt-4 border-t border-slate-200/70 dark:border-white/5 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
