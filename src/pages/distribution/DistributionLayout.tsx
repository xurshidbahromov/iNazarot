...
const tabs = [
  { name: 'Yetkazib berish (Dostavka)', href: '/distribution/shipments' },
              ...
              <Link
                ...
                className={cn(
                  isActive
                    ...
                    : 'border-transparent text-slate-500 dark:text-slate-400 hover:border-slate-200 dark:border-transparent hover:text-slate-700 dark:text-slate-300',
